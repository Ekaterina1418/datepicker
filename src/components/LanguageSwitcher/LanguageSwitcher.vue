<template>
  <div class="custom-select">
    <select id="locale" class="select-locale" v-model="currentLang" @change="onChange">
...
const currentLang = ref<string>(languages[0]?.code || 'ru');

const onChange = () => {
	emit('update:lang',currentLang.value)
}
</script>
